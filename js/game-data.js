...
window.ONYU_CHAPTERS = [
  ...
  {
    id: 'ch06', order: 6, grade: 1, season: 'autumn', title: '가을 소풍',
    script: [
...

  {
    ...
    script: [
      ...
      { type: 'narration', text: '카페에 자리를 잡고 앉자, 그녀가 컵을 만지작거리며 입을 열었다. 창밖으로 축제의 여운이 남은 교정이 어스름하게 저물고 있었다.' },
...

  {
    ...
    script: [
      ...
      { type: 'narration', text: '첫 판은 그녀의 압승이었다. 승리가 확정되는 순간, 그녀가 장난스럽게 플레이어의 손을 덥석 잡아 번쩍 들어 올렸다.' },
...

  {
    ...
    script: [
      ...
      { type: 'narration', text: '멀어지는 그녀의 뒷모습이 며칠 전보다 조금 더 작아 보였다. 학원 문이 닫히는 소리가 유난히 크게 울렸다. 창 너머로 불이 하나둘 켜지는 학원 건물을, 플레이어는 한참을 서서 바라보았다.' },
    ],
  },
