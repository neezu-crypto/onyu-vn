...
window.ONYU_CHAPTERS = [
  {
    ...
    script: [
        ...
        options: [
          {
            ...
            script: [
              ...
              { type: 'line', speaker: 'onyu', text: '(고개를 들며) 어... 응.' },
              { type: 'line', speaker: 'player', text: '진짜 잘 그렸다.' },
              { type: 'line', speaker: 'onyu', text: '고마워. 그렇게 말해주는 사람, 별로 없었는데.' },
              { type: 'line', speaker: 'player', text: '뭐 그린 거야?' },
              { type: 'line', speaker: 'onyu', text: '그냥 창밖 풍경. 아직 다 못 그렸어.' },
              { type: 'line', speaker: 'player', text: '다 그리면 보여줘.' },
              { type: 'line', speaker: 'onyu', text: '(살짝 웃으며) 그러든가.' },
              { type: 'line', speaker: 'player', text: '미술부야?' },
              { type: 'line', speaker: 'onyu', text: '아니, 디자인과 준비용. 좋아서 하는 건 아니고.' },
              { type: 'line', speaker: 'player', text: '그럼 뭘 좋아하는데?' },
              { type: 'line', speaker: 'onyu', text: '...그건 나중에.' },
            ],
          },
          {
        ...
        options: [
          {
            ...
            script: [
              ...
              { type: 'line', speaker: 'onyu', text: '(쉬는 시간, 다가와서) 아까, 고마워.' },
              { type: 'line', speaker: 'player', text: '뭐가?' },
              { type: 'line', speaker: 'onyu', text: '그냥. 먼저 나서준 거.' },
              { type: 'line', speaker: 'player', text: '별거 아니었어.' },
              { type: 'line', speaker: 'onyu', text: '그래도. ...그렇게 막 나서는 거, 은근 별로 안 싫더라.' },
            ],
          },
          {
      ...
      { type: 'line', speaker: 'onyu', text: '저기, 너 이름이 뭐야?' },
      { type: 'nameInput' },
      { type: 'line', speaker: 'player', text: '(이름을 말한다)' },
      { type: 'line', speaker: 'onyu', text: '(되뇌며) 그렇구나. 알겠어.' },
      { type: 'line', speaker: 'player', text: '너는?' },
      { type: 'line', speaker: 'onyu', text: '온이유.' },
      { type: 'line', speaker: 'player', text: '이유... 이름 특이하다.' },
      { type: 'line', speaker: 'onyu', text: '많이 듣는 말이야.' },
      { type: 'line', speaker: 'player', text: '왜, 무슨 뜻인데?' },
      { type: 'line', speaker: 'onyu', text: '(잠깐 생각하다가) ...나중에 알려줄게.' },
...

  {
    ...
    script: [
        ...
        options: [
          {
            ...
            script: [
              ...
              { type: 'line', speaker: 'onyu', text: '너도 이런 거 볼 줄 아는구나.' },
              { type: 'line', speaker: 'player', text: '무슨 소리야, 나도 눈 있거든.' },
              { type: 'line', speaker: 'onyu', text: '(피식) 그런 뜻 아니었는데.' },
              { type: 'line', speaker: 'player', text: '알아. 놀린 거야.' },
              { type: 'line', speaker: 'onyu', text: '(살짝 웃으며) 여유 좀 있네.' },
              { type: 'line', speaker: 'player', text: '너도 여유 있어 보이는데.' },
              { type: 'line', speaker: 'onyu', text: '오늘만 그래.' },
            ],
          },
          {
            ...
            script: [
              ...
              { type: 'line', speaker: 'onyu', text: '(흠칫 놀라며) ...어, 그래.' },
      ...
      { type: 'line', speaker: 'onyu', text: '과제 마감이 코앞이라. 안 그러면 나도 안 들고 다녀.' },
      { type: 'line', speaker: 'player', text: '그럼 집에서는 뭐 해?' },
      { type: 'line', speaker: 'onyu', text: '(웃으며) 그건 비밀이라니까.' },
      {
        type: 'choice',
        ...
        options: [
          {
            ...
            script: [
              ...
              { type: 'line', speaker: 'onyu', text: '가만히 있어 줘서 고마워.' },
              { type: 'line', speaker: 'player', text: '방해하는 것 같아서.' },
              { type: 'line', speaker: 'onyu', text: '아니야. 오히려 편해. ...이런 거 자꾸 말하게 하지 마.' },
          ...
          },
          {
            ...
            script: [
              ...
              { type: 'line', speaker: 'onyu', text: '(스케치북을 덮으며) 나 먼저 갈게.' },
      ...
      { type: 'line', speaker: 'onyu', text: '봄이 생각보다 짧네.' },
      { type: 'line', speaker: 'player', text: '그게 무슨 말이야?' },
      { type: 'line', speaker: 'onyu', text: '(웃으며) 그냥. 벚꽃이 빨리 지는 것 같아서.' },
      { type: 'line', speaker: 'player', text: '내년에도 같이 보면 되지.' },
      { type: 'line', speaker: 'onyu', text: '(잠깐 이쪽을 보다가) ...그러네.' },
